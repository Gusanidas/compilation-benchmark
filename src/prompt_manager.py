...
def get_prompt_misc(programming_language: str, problem: Problem) -> str:
    ...
    if programming_language == "rust":
        ...
        raise ValueError(f"Unsupported prompt for programming language: {programming_language}")
...
def get_correction_prompt(programming_language: str, problem:  Problem, code: str, api_response: ExecuteCodeResponse) -> str:
